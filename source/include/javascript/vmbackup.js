...
/** start functions for Vmbackup all pages **/
  ...
  function tab_click_events() {
    ...
    // add custom click function to Danger Zone tab.
...
/** start functions for Vmbackup4DangerZone **/
  // function to inject inline css for ddcl-vms_to_backup_running-ddw (an autogenerated div) and its first child div.
  // this fixes the dimensions of the vms_to_backup_running dropdown box so that it will actually display.
  function fix_css_vms_to_backup_running() {
    // inject css for ddcl-vms_to_backup_running-ddw.
    $("#ddcl-vms_to_backup_running-ddw").css("width", "188px");
    $("#ddcl-vms_to_backup_running-ddw").css("height", "266px");
    $("#ddcl-vms_to_backup_running-ddw div").first().css("height", "266px");
  }
...
/** start functions for Vmbackup5ManageConfigs **/
  ...
  function toggle_inline_help_vmbackup_manage_configs() {
    ...
    $('#manage_configs_div').off('click', '#rename_delete_configs_div .input_description');
    $('#manage_configs_div').on('click', '#rename_delete_configs_div .input_description', function (e) {
      e.preventDefault();
      $(this).nextAll('.custom_inline_help:first').toggle('slow');
    });
  }
